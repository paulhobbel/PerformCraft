...
const (
	HandshakingHandshake base.PacketID = iota // 0x00
)

// Status State
// Clientbound packet IDs
const (
	StatusRequest base.PacketID = iota // 0x00
	StatusPing                         // 0x01
)

const (
	StatusResponse base.PacketID = iota // 0x00
	StatusPong                          // 0x01
)
...
// Clientbound packet IDs
const (
	LoginDisconnect        base.PacketID = iota // 0x00
...
const (
	LoginStart              base.PacketID = iota // 0x00
...
const (
	PlaySpawnEntity              base.PacketID = iota // 0x00
